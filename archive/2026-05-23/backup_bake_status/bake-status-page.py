...
try:
    ...
    # Model: UV * 44W * cloud_factor * solar_angle_factor (校正係數: 18.2→44, 實測144W@UV5驗證)
    eff_w = uv_val * 44 * cloud_factor * angle_factor
    eff_w = min(eff_w, 150)  # cap at panel max (actual ~130W in good conditions)
    eff_pct = eff_w / 150 * 100
