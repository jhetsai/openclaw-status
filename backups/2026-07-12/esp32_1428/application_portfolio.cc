...
void PortfolioApplication::CreateWeatherScreen() {
    ...
    for (int i = 0; i < Weather::FORECAST_DAYS; i++) {
        ...
        lv_obj_set_pos(det_fc_day_[i], (fc_cell_w - 40) / 2, 12);  // center top, below clip radius
        ...
        lv_obj_set_pos(det_fc_temp_[i], 6, fc_cell_h - 28);
        ...
        lv_obj_set_pos(det_fc_rain_[i], fc_cell_w - 62, fc_cell_h - 28);
