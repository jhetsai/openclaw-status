...
class ElectricityApp:
    ...
    def _build_header(self):
        f = tk.Frame(self.root, bg="#1565C0", padx=20, pady=15)
        f.pack(fill="x")
    ...
    def _build_summary_cards(self):
        cf = tk.Frame(self.root, bg="#F0F4F8", padx=16, pady=10)
        cf.pack(fill="x")
    ...
    def _build_controls(self):
        cf = tk.Frame(self.root, bg="#F0F4F8", padx=16, pady=8)
        cf.pack(fill="x")
    ...
    def _build_meter_info(self):
        self.mi_frame = tk.Frame(self.root, bg="white", padx=16, pady=12,
    ...
    def _build_charts(self):
        self.charts_frame = tk.Frame(self.root, bg="#F0F4F8", padx=16, pady=8)
    ...
    def _build_meter_table(self):
        ...
        self.meter_box = tk.Frame(self.root, bg="white",
                                  highlightbackground="#DDD", highlightthickness=1)
        ...
        scroll_x = ttk.Scrollbar(self.meter_box, orient="horizontal",
                               command=self.meter_tree.xview)
        scroll_x.pack(side="bottom", fill="x")
        self.meter_tree.configure(xscrollcommand=scroll_x.set)

    def _build_detail_table(self):
        self.detail_box = tk.Frame(self.root, bg="white",
                                    highlightbackground="#DDD", highlightthickness=1)
        ...
        scroll_x.pack(side="bottom", fill="x")
        self.detail_tree.configure(xscrollcommand=scroll_x.set)

    def _build_footer(self):
        tk.Label(
            self.root, text="台電e-Bill | 蝦助 🦐",
            font=("Microsoft JhengHei", 10),
            fg="#999", bg="#F0F4F8"
        ).pack(pady=(0, 8))
