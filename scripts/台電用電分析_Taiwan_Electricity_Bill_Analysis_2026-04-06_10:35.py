...
class ElectricityApp:
    ...
    def _build_controls(self):
        ...
        for label, val in modes:
            rb = tk.Radiobutton(
                ...
                font=("Microsoft JhengHei", 11),
                bg="#F0F4F8", fg="#333",
                selectcolor="#E3F2FD", activebackground="#F0F4F8",
    ...
    def _build_meter_table(self):
        ...
        self.meter_box = tk.Frame(self.root, bg="white",
                                  highlightbackground="#DDD", highlightthickness=1)
        self.meter_box.pack(fill="x", padx=16, pady=(0, 10))
        ...
        self.meter_tree.pack(fill="x", padx=12, pady=(0, 10))
